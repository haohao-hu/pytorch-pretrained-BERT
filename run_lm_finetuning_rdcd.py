...
class BERTDataset(Dataset):
    ...
    def get_corpus_line(self, item):
        ...
        if self.on_memory:
            ...
            if self.with_category:
                ...
                t1 = self.all_docs[sample["category_encode"]][sample["within_cat_doc_id"]][0]
                ...
                t2 = self.all_docs[sample["category_encode"]][rdn_idx][0]
    ...
    def get_random_line(self):
        ...
        """
                    ...
                    line = rand_doc[random.randrange(len(rand_doc))][0]
