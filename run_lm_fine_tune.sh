...
python run_lm_finetuning_rdcd.py \
  ...
  --output_dir /storage/pytorch-pretrained-BERT/models/rdcd_fine_tune_lm_no_truncate_testing_86_2 \
  ...
  --on_memory \
  --with_category  > /artifacts/e5-lr3e-5-bs32-msl325-bert-lm-lg.log
