...
#cd ..
tensorboard --logdir='/storage/pytorch-pretrained-BERT/logs' --port=8888:8888
...
python run_lm_finetuning_rdcd.py \
  ...
  --output_dir /storage/pytorch-pretrained-BERT/models/rdcd_fine_tune_lm_testing_train600k_find_lr \
